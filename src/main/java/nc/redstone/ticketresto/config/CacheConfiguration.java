...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, nc.redstone.ticketresto.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, nc.redstone.ticketresto.repository.UserRepository.USERS_BY_EMAIL_CACHE);
